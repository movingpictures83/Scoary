...
from plugins.Scoary.scoary.citation import citation
from plugins.Scoary.scoary.classes import Matrix
from plugins.Scoary.scoary.classes import QuadTree
from plugins.Scoary.scoary.classes import PhyloTree
from plugins.Scoary.scoary.classes import PimpedFileHandler
from plugins.Scoary.scoary.classes import ScoaryLogger
from plugins.Scoary.scoary.__init__ import __version__
#import scoary
...
class MyArgs:
    def __init__(self):
       self.traits = ""
       self.genes = ""
       self.newicktree = None
       self.start_col = 15
       self.delimiter = ','
       self.restrict_to = None
       self.upgma_tree = False
       self.correction = ['I']
       self.p_value_cutoff = [0.05]
       self.cutoffchoices = ['I']
       self.max_hits = 100
       self.include_input_columns = []
...
class ScoaryPlugin:
 ...
 def output(self, outputfile):
    ...
    args = MyArgs()
    args.traits = PyPluMA.prefix()+"/"+self.parameters["traits"]
    args.genes = PyPluMA.prefix()+"/"+self.parameters["genes"]
    args.outdir = outputfile
